...
<?php switch($field["type"]): case "text": ?><input type="text" name="<?php echo ($field["name"]); ?>" value="<?php echo (htmlspecialchars($field["value"])); ?>"
    ...
    <?php case "icon": ?><div class='icon-chose' title=<?php echo L("_SELECT_ICON_WITH_DOUBLE_");?> style="width: 400px;">
        ...
        <script src="/admin/Application/Admin/Static/zui/lib/chosen/chosen.icons.min.js"></script>
        <link href="/admin/Application/Admin/Static/zui/lib/chosen/chosen.icons.css" rel="stylesheet">
        <?php } ?>
        <script>
            $(function(){
    ...
    <?php case "autoComplete": $delimiter = $field['opt']['delimiter']?$field['opt']['delimiter']:','; ?>
        ...
        <script src="/admin/Public/js/ext/tokeninput/jquery.tokeninput.js"></script>
        <link href="/admin/Public/js/ext/tokeninput/token-input-facebook.css" rel="stylesheet">
...
<script type="text/javascript">
    ...
    <?php if($chosen_select2): ?><link rel="stylesheet" href="/admin/Application/Admin/Static/adminlte/plugins/select2/select2.min.css">
        <script src="/admin/Application/Admin/Static/adminlte/plugins/select2/select2.full.min.js"></script>
        <script>
            $(function(){
                $(".select2").select2();
            })
        </script><?php endif; ?>
    <?php if($has_nestable): ?><link href="/admin/Application/Admin/Static/bootstrap/plugins/jquery-nestable/jquery.nestable.css" rel="stylesheet" type="text/css"/>
        <script src="/admin/Application/Admin/Static/bootstrap/plugins/jquery-nestable/jquery.nestable.js" type="text/javascript"></script>
        <script src="/admin/Application/Admin/Static/bootstrap/js/ui-nestable.min.js" type="text/javascript"></script>
        <script>
    ...
    <?php if($importDatetimePicker): ?><link href="/admin/Application/Admin/Static/bootstrap/plugins/datetimepicker/datetimepicker.css" rel="stylesheet" type="text/css">
        <script type="text/javascript" src="/admin/Application/Admin/Static/bootstrap/plugins/datetimepicker/datetimepicker.min.js"></script>
    ...
    <?php if($colorPicker): ?><script type="text/javascript" src="/admin/Application/Admin/Static/js/jquery.simple-color.js"></script>
        <script>
            $(function(){
    ...
    <link type="text/css" rel="stylesheet" href="/admin/Public/js/ext/magnific/magnific-popup.css"/>
    <script type="text/javascript" src="/admin/Public/js/ext/magnific/jquery.magnific-popup.min.js"></script>

    <script type="text/javascript" charset="utf-8" src="/admin/Public/js/ext/webuploader/js/webuploader.js"></script>
    <link href="/admin/Public/js/ext/webuploader/css/webuploader.css" type="text/css" rel="stylesheet">
